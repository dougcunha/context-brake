...
- The SDD skills in `.agents/skills/` run this flow; `sdd-orchestrate-flow` drives a feature from PRD to acceptance with human checkpoints and keeps its resumable state in the feature's `checkpoint.json`.
