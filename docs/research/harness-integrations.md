...
| Antigravity CLI | `hooks.json` em `.agents/` | Deferido para o PRD-02 (`PreInvocation` no PRD-01) | *Não documentado*; indireto por `PreInvocation` | Indireto por `PreInvocation` | *Não documentado* | Relatos de terceiros indicam fail-closed |
