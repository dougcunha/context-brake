...
async function handleSessionStart(payload: unknown, context: PiContext, resolver: InProcessRuntimeResolver): Promise<void> {
...
async function handleSessionCompact(payload: unknown, context: PiContext, resolver: InProcessRuntimeResolver): Promise<void> {
