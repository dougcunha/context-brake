...
`codereview_04` corrections T12–T16 are complete and archived in `./codereview_04/done/`. `codereview_05` corrections T17–T22 are complete and archived in `./codereview_05/done/`, and `codereview_06` corrections T23–T24 in `./codereview_06/done/`. T16 was closed by HIL decision on 2026-09-14 with Windows and WSL 2 Linux evidence from revision `58082e5`. CA-20 was later verified on Ubuntu, macOS, and Windows by GitHub Actions run 34881898428 on `1d4bbb5`.
