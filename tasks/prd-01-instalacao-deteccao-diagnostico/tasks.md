...
`codereview_04` corrections T12–T15 are complete and archived in `./codereview_04/done/`. T16 stays pending at `./codereview_04/task_16.md` because it requires an immutable revision plus Linux/macOS CI matrix evidence.
